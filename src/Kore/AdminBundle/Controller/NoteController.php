...
use Kore\AdminBundle\Form\NoteType;
...
class NoteController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        if($sort) $notes = $em->getRepository('KoreAdminBundle:Note')->findBy(array(), array($sort => $direction));
        else $notes = $em->getRepository('KoreAdminBundle:Note')->findAll();
        ...
        return $this->render('KoreAdminBundle:Note:index.html.twig', array(
            'notes' => $notes,
            'direction' => $direction,
            'sort' => $sort,
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('KoreAdminBundle:Note:new.html.twig', array(
    ...
    public function showAction(Note $note)
    {
        ...
        return $this->render('KoreAdminBundle:Note:show.html.twig', array(
            'note' => $note,
    ...
    public function editAction(Request $request, Note $note)
    {
        ...
        return $this->render('KoreAdminBundle:Note:edit.html.twig', array(
            'note' => $note,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
