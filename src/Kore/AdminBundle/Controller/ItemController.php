...
use Kore\AdminBundle\Form\ItemType;
...
class ItemController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('KoreAdminBundle:Item:index.html.twig', array(
            'items' => $items,
            'direction' => $direction,
            'sort' => $sort,
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('KoreAdminBundle:Item:new.html.twig', array(
    ...
    public function showAction(Item $item)
    {
        ...
        return $this->render('KoreAdminBundle:Item:show.html.twig', array(
            'item' => $item,
    ...
    public function editAction(Request $request, Item $item)
    {
        ...
        return $this->render('KoreAdminBundle:Item:edit.html.twig', array(
            'item' => $item,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
