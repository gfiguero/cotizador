...
use Kore\AdminBundle\Form\ClientType;
...
class ClientController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('KoreAdminBundle:Client:index.html.twig', array(
            'clients' => $clients,
            'direction' => $direction,
            'sort' => $sort,
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('KoreAdminBundle:Client:new.html.twig', array(
    ...
    public function showAction(Client $client)
    {
        ...
        return $this->render('KoreAdminBundle:Client:show.html.twig', array(
            'client' => $client,
    ...
    public function editAction(Request $request, Client $client)
    {
        ...
        return $this->render('KoreAdminBundle:Client:edit.html.twig', array(
            'client' => $client,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
