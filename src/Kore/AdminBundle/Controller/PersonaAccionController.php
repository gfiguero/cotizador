...
use Kore\AdminBundle\Form\PersonaAccionType;
...
class PersonaAccionController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('KoreAdminBundle:PersonaAccion:index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('KoreAdminBundle:PersonaAccion:new.html.twig', array(
    ...
    public function showAction(PersonaAccion $personaAccion)
    {
        ...
        return $this->render('KoreAdminBundle:PersonaAccion:show.html.twig', array(
    ...
    public function editAction(Request $request, PersonaAccion $personaAccion)
    {
        ...
        return $this->render('KoreAdminBundle:PersonaAccion:edit.html.twig', array(
            'personaAccion' => $personaAccion,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
