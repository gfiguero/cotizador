...
use Kore\AdminBundle\Form\RutaEstadoType;
...
class RutaEstadoController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('KoreAdminBundle:RutaEstado:index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('KoreAdminBundle:RutaEstado:new.html.twig', array(
    ...
    public function showAction(RutaEstado $rutaEstado)
    {
        ...
        return $this->render('KoreAdminBundle:RutaEstado:show.html.twig', array(
    ...
    public function editAction(Request $request, RutaEstado $rutaEstado)
    {
        ...
        return $this->render('KoreAdminBundle:RutaEstado:edit.html.twig', array(
            'rutaEstado' => $rutaEstado,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
