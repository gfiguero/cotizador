...
use Kore\AgentBundle\Form\SolicitudEstadoType;
...
class SolicitudEstadoController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('KoreAgentBundle:SolicitudEstado:index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('KoreAgentBundle:SolicitudEstado:new.html.twig', array(
    ...
    public function showAction(SolicitudEstado $solicitudEstado)
    {
        ...
        return $this->render('KoreAgentBundle:SolicitudEstado:show.html.twig', array(
    ...
    public function editAction(Request $request, SolicitudEstado $solicitudEstado)
    {
        ...
        return $this->render('KoreAgentBundle:SolicitudEstado:edit.html.twig', array(
            'solicitudEstado' => $solicitudEstado,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
