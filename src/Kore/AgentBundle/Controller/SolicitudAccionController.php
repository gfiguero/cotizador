...
use Kore\AgentBundle\Form\SolicitudAccionType;
...
class SolicitudAccionController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('KoreAgentBundle:SolicitudAccion:index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('KoreAgentBundle:SolicitudAccion:new.html.twig', array(
    ...
    public function showAction(SolicitudAccion $solicitudAccion)
    {
        ...
        return $this->render('KoreAgentBundle:SolicitudAccion:show.html.twig', array(
    ...
    public function editAction(Request $request, SolicitudAccion $solicitudAccion)
    {
        ...
        return $this->render('KoreAgentBundle:SolicitudAccion:edit.html.twig', array(
            'solicitudAccion' => $solicitudAccion,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
